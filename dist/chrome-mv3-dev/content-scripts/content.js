...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  **/
  ...
  function _sfc_render(_ctx, _cache) {
    return openBlock(), createElementBlock("div", _hoisted_1, " 测试信息 ");
  }
  const InterceptionApi = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b2d9841e"], ["__file", "F:/Qinwei文件夹/wxt-vue-apiTest/src/components/InterceptionApi.vue"]]);
  const definition = defineContentScript({
    ...
    async main(ctx) {
      ...
      window.addEventListener("message", (event) => {
        var _a2;
        if (((_a2 = event.data) == null ? void 0 : _a2.type) === "NETWORK_RESPONSE") {
